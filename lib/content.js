...
export const storiesContent = {
    ...
    description: 'At Mirabel, we believe beauty is a journey of self-discovery and empowerment. Every story we create is a celebration of individuality, confidence, and the transformative power of self-care.',
    stories: [
...
export const testimonialsContent = {
    ...
    testimonials: [
        ...
        {
            name: 'Amanda Lewis',
            text: 'The facial treatment was divine. My skin feels so rejuvenated and glowing. The staff really knows their stuff!',
            rating: 5
        },
        {
            name: 'Rachel Green',
            text: 'Love the vibe here! It’s so chic and modern. Got a balayage done and it looks absolutely stunning. 10/10 would recommend.',
            rating: 5
        },
        {
            name: 'Sophie Turner',
            text: 'Professional, clean, and incredibly talented staff. My nails have never looked this good. A true gem in the city.',
            rating: 5
        }
    ]
};
...
export const footerContent = {
    ...
    social: {
        ...
        snapchat: 'https://www.tiktok.com/@mirabelsalone',
        tiktok: 'https://www.tiktok.com/@mirabelsalone',
        youtube: 'https://www.youtube.com/@mirabel_alain',
        pinterest: 'https://www.pinterest.com/mirabel_alain/'
    },
    contact: {
